...
WALLET_FILE_NAME = "wallets_with_balance.txt"
wallets_scanned = 0

directory = os.path.dirname(os.path.abspath(__file__))
log_file_path = os.path.join(directory, LOG_FILE_NAME)
env_file_path = os.path.join(directory, ENV_FILE_NAME)
wallet_file_path = os.path.join(directory, WALLET_FILE_NAME)
...
if not os.path.exists(env_file_path):
    print("The breadcracker.env file doesn't exist. Let's create it!")
